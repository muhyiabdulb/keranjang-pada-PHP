...
?>
<h2> Item dalam keranjang Anda: </h2> 
<form method="POST">
<table id="t01">
<tr>
	<th>Option</th>
...
<?php 
 ...
 ?>	
   <tr>
    	<td><a href="cart.php?index=<?php echo $index; ?>" onclick="return confirm('Serius nih, dihapus...?')" >Hapus</a> </td>
...
<br>
<a href="index.php">Tambah Barang</a> | <a href="checkout.php">Keluar</a>
<?php 
